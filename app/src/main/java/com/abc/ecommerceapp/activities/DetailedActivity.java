...
public class DetailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button tryon = findViewById(R.id.tryon);
        ...
        if (newProductsModel != null) {
            ...
            name.setText(newProductsModel.getName());
            applylensebyid = (String.valueOf(newProductsModel.getApplylensebyid()));
        ...
        if (popularProductsModel != null) {
            ...
            name.setText(popularProductsModel.getName());
            applylensebyid = (String.valueOf(popularProductsModel.getApplylensebyid()));
        ...
        if (showAllModel != null) {
            ...
            name.setText(showAllModel.getName());
            applylensebyid = (String.valueOf(showAllModel.getApplylensebyid()));
        ...
        tryon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DetailedActivity.this, tryon.class);
                intent.putExtra("applylensebyid", applylensebyid);
